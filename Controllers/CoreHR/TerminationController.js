const db = require("../../Models/CoreHR/TerminationModel");
  ...
  try {
    ...
    res
      ...
      .json({
        success: true,
        TerminationAllData,
        message: "All Termination Data Fetched successfully",
      });
  } catch (error) {
  ...
  try {
    ...
    res
      ...
      .json({
        success: true,
        TerminationData,
        message: "Termination Single Data Fetched successfully",
      });
  } catch (error) {
    res.status(404).json({ message: error.message });
  }
...
const deleteData = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "Termination Removed successfully" });
  } catch (error) {
    res.status(404).json({ message: error.message });
  }
};
