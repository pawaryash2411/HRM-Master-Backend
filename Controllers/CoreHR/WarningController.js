const db = require("../../Models/CoreHR/WarningModel");
...
const getAllData = async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      WarningAllData,
      message: "All Warning Data Fetched successfully",
    });
  } catch (error) {
...
const getSingleData = async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      WarningData,
      message: "Warning Single Data Fetched successfully",
    });
  } catch (error) {
    res.status(404).json({ message: error.message });
  }
...
const deleteData = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "Warning Removed successfully" });
  } catch (error) {
    res.status(404).json({ message: error.message });
  }
};
